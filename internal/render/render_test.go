...
func TestGolden(t *testing.T) {
	...
	cases := []struct {
		...
		{"mysql.cnf", "mysql/monopanel.cnf.tmpl", MySQLConf{RAMMB: 4096, BindAddress: "127.0.0.1", BufferPoolMB: 1024, RedoLogMB: 256, MaxConnections: 200, SlowLog: "/var/log/mysql/monopanel-slow.log", NativePassword: true}, []string{"innodb_buffer_pool_size = 1024M", "mysql_native_password = ON", "authentication_policy = mysql_native_password,,"}},
