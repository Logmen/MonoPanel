...
ветка PHP, пресет CMS, подкаталог docroot, SSL, редирект www, пул php-fpm, доступ только
с перечисленных IP и флаги HTTP/2, HTTP/3 и HSTS. «Сохранить и применить» ставит задачу:
...
fail2ban, memcached, jpegoptim, git, composer и Sphinx для 1С-Битрикс — с версией,
