...
Скриншоты сняты с примерного сервера — Ubuntu 24.04, MonoPanel 0.8.7, сайты на
...
Веб-серверы, СУБД, fail2ban, memcached, jpegoptim, git, composer и Sphinx ставятся на
странице «Расширения».
