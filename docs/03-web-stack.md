...
Нужно расширение redis у ветки PHP сайта. Сокет с правами 600 принадлежит аккаунту: пул сайта работает от его имени и подключается, пулы других аккаунтов — нет ([02](02-platform-matrix.md#9-valkey-на-аккаунт)).
